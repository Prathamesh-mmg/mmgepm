...
public class CrewAttendance : BaseEntity
{
    ...
    // Labour approval workflow (M2-9)
    [MaxLength(50)] public string ApprovalStatus { get; set; } = "Pending"; // Pending|Approved|Rejected
    public Guid? ApprovedById  { get; set; }
    public DateTime? ApprovedAt { get; set; }
    [MaxLength(500)] public string? RejectionRemarks { get; set; }
    // Trade tracking (M2-1)
    [MaxLength(100)] public string? TradeCode { get; set; }
...
public class DPRReport : BaseEntity
{
    ...
    // DPR extended fields (PM-EXT-7)
    [MaxLength(500)] public string? LocationOfWork { get; set; }
    [MaxLength(50)]  public string? WeatherType    { get; set; } // Normal|Rainy
